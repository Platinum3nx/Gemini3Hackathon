...
class GitHubService:
    ...
    def create_fix_pr(
        ...
        Args:
            ...
            original_branch: The branch the user pushed to
        ...
        fix_branch = f"argus-fix-{timestamp}"
        ...
        pr_body = self._generate_pr_body(fixes, proofs)
        
        # Create the Pull Request
        print(f"[GitHub Service] Creating Pull Request...")
        
        try:
            pr = repo.create_pull(
                title="🛡️ Argus: Verified Security Fixes",
                body=pr_body,
                head=fix_branch,
    ...
    def _generate_pr_body(
        ...
        """
        lines = [
            "# 🛡️ Argus Auto-Remediation Report",
            "",
